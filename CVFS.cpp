...
void man(char *name)
{
    ...
    else if(strcmp(name,"write") == 0)
    {
        ...
        printf("Usage : write File_name\n After this enter the data we want to writen\n");
    }
...
void DisplayHelp()
{
    ...
    printf("write : To write contents in the files\n");
    printf("exit : To terminate files system\n");
...
int WriteFile(int fd,char *arr,int isize)
{
    ...
    if((UFDTArr[fd].ptrfiletable->writeoffset) == WRITE)
    {
        return -2;
    }
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create")== 0)
            {
                ...
                if(ret == -3)
                {
                    printf("ERROR : File allready exits\n");
                }
                if(ret == -4)
                {
                    printf("ERROR : Memory location failure\n");
                    continue;
                }
            }    
            ...
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ret == -3)
                {
                    printf("ERROR : Reach at end of the file\n");
                }
                if(ret == -4)
                {
                    printf("ERROR : Its not regular file\n");
                }
                if(ret == 0)
                {
